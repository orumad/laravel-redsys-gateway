...
use Orumad\LaravelRedsys\Exceptions\NotificationResponseCodeException;

abstract class NotificationsResponses
{
    public static function getResponse(int $responseCode): string
    {
        ...
        throw NotificationResponseCodeException::invalidResponseCode();
    }
}
